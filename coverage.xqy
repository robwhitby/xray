...
import module namespace cover="http://github.com/robwhitby/xray/coverage" at "src/coverage.xqy";
...
(: wanted lines :)
declare variable $wanted as xs:integer* := xs:integer(xs:NMTOKENS(xdmp:get-request-field("wanted")));

(: covered lines :)
declare variable $covered as xs:integer* := xs:integer(xs:NMTOKENS(xdmp:get-request-field("covered")));
